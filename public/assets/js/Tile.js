...
/**
 *  Prerender all tiles by converting
 *  them to offcanvases and render the tile onto them.
 *  @return void
 */
Tile.prerenderAll = function() {
	Tile.prototype.sprites = Object.keys(Tile.prototype.sprites).reduce(
		(acc, key) => {
			const offCanvas = document.createElement("canvas");
			const sprite = Tile.prototype.sprites[key];
			offCanvas.width = sprite.width;
			offCanvas.height = sprite.height;
			offCanvas.getContext("2d").drawImage(sprite, 0, 0);
			acc[key] = offCanvas;
			return acc;
		},
		{},
